    ...
    public static void bill(int rn, int rtype)
    {
        ...
        switch(rtype){
            case 1:
                ...
                System.out.println("-------------------------");
                for(Food obb: hotelOb.luxuryDoubleroom[rn].orders){
                    amount += obb.price;
            ...
            case 2:
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb: hotelOb.deluxeDoubleroom[rn].orders){
                    amount += obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format, list[obb.itemno - 1], obb.quantity, obb.price);
                }
            ...
            case 3:
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb: hotelOb.luxurySingleeroom[rn].orders){
                    amount += obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format, list[obb.itemno - 1], obb.quantity, obb.price);
                }
            ...
            case 4:
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb: hotelOb.deluxeSingleeroom[rn].orders){
                    amount += obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format, list[obb.itemno - 1], obb.quantity, obb.price);
                }
